...
// const client_id = "691130356089-h64l76oifo3cio9kse5e8l70tg11f7g7.apps.googleusercontent.com"
...
const Register = () => {
  ...
  const onSuccess = (credentialResponse) => {
    ...
    Cookies.set('userdata',JSON.stringify({
          nickname:decodedResponse.family_name,
          codename:decodedResponse.given_name,
          firstname:decodedResponse.family_name
    }),{secure: false, sameSite: 'Strict',expires: 2})
  ...
  return (
    <div className='bg-[#272525] h-screen w-screen flex flex-col justify-center items-center'>
      ...
      <div className='bg-[#C3E7D9] w-11/12 h-3/4 rounded-3xl lg:w-3/7 lg:h-3/4'>
      <form onSubmit={handlesubmit}>
        ...
        {/* <div className="mt-10 ml-10 mr-10 mb-10 w-5/6">
